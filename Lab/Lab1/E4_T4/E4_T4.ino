...
Example code on Accelerometer and Gyroscope from the lab instruction.
*/
...
void loop() {
    ...
    // Printing the pitch, roll, yaw, and elevation on the LCD
    ...
    */
    ...
    // For debugging on the serial monitor
    Serial.print("Pitch: ");
    Serial.print(pitch);
    Serial.print(", Roll: ");
    Serial.print(roll);
